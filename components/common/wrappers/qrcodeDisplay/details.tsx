import { ArrowSvg } from '@/components/common/svgs/arrowSvg';
import { CheckMarkSvg } from '@/components/common/svgs/checkMarkSvg';
import { ResetSvg } from '@/components/common/svgs/resetSvg';
